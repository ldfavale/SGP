...
Modificada y adaptada por Fredd Hannay 
*/

class SubirImagen {
	# Variables #
	private $_exts = array("image/jpg", "image/jpeg", "image/png", "image/gif"); // Tipos de archivos soportados
	private $_width = 300; // Ancho máximo por defecto
	private $_height = 300; // Alto máximo por defecto
	private $_size = 500000; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor byts
	private $_name = "imagen"; // Nombre por defecto 
	private $_dest = "public/img/";
	private $_img;
	private $_ext;
	private $_r = "";
	# Métodos mágicos #
	...
	public function asignaNombre() { 
		...
		// Asignamos el nombre a la imagen con la extencion correspondiente
